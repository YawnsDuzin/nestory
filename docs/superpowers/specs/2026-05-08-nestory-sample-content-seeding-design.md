...
- `--reset` 동작 확장: `./media/images/` 폴더 청소 (settings.image_base_path 기준)
...
- `./media/images/<id>/` 에 orig + thumb(jpg+webp) + medium(jpg+webp) 파일 5개씩 (각 이미지당 5 파일 — handler가 jpg+webp 양쪽 출력)
